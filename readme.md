...
Alternatively, for H1 and H2, there is an underline-style:
...
Inline-style: 
![alt text](https://raw.githubusercontent.com/emielvanloon/markdown/main/markdown_black.png "Logo Title Text 1")

Reference-style: 
![alt text][logo]

[logo]: https://raw.githubusercontent.com/emielvanloon/markdown/main/markdown_black.png "Logo Title Text 2"
```
...
Tables aren't part of the core Markdown spec, but they are part of GFM (and many editors supports them). They are an easy way of adding tables to your email -- a task that would otherwise require copy-pasting from another application.
